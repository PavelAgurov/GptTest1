...
TOPICS_LIST = [
   ...
   [6, "Our science",  "The scientific foundation of smoke-free vision, showcasing research, innovations, methodologies, technologies, and breakthroughs across various fields, including collaborations, experiments, publications, and applications."],
   [7, "Smoke-free vision",  "Centers on societal and corporate mission, highlighting its dedication to providing millions of smokers with less harmful but satisfying alternatives through innovative smoke-free products, aiming to accelerate the transition towards a cigarette-free world."],
   [8, "PMI Transformation", "Centers on transformation from a cigarette-focused company to one offering improved smoke-free alternatives, marking a significant historical shift with organizational, management, and vision implications, aiming to drive positive societal change towards a smoke-free future."],
   ...
   [10, "Regulation", " Focuses on the need for a regulatory framework to encourage smoke-free products, highlighting how governments and public health bodies can regulate these alternatives to promote public health and reduce cigarette sales for a smoke-free future."],
   ...
   [12, "Partnership and Engagement", "Collaborative efforts, strategic alliances, and community engagement fostering positive impact through meaningful engagement with various external entities."]
]
